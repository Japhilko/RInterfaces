...
<!--html_preserve--><div id="plot_id163682884-container" class="ggvis-output-container">
<div id="plot_id163682884" class="ggvis-output"></div>
...
<li>
Renderer: 
<a id="plot_id163682884_renderer_svg" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id163682884" data-renderer="svg">SVG</a>
 | 
<a id="plot_id163682884_renderer_canvas" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id163682884" data-renderer="canvas">Canvas</a>
</li>
<li>
<a id="plot_id163682884_download" class="ggvis-download" data-plot-id="plot_id163682884">Download</a>
</li>
</ul>
</nav>
</div>
...
ggvis.getPlot("plot_id163682884").parseSpec(plot_id163682884_spec);
...
<!--html_preserve--><div id="plot_id335221466-container" class="ggvis-output-container">
<div id="plot_id335221466" class="ggvis-output"></div>
<div class="plot-gear-icon">
<nav class="ggvis-control">
<a class="ggvis-dropdown-toggle" title="Controls" onclick="return false;"></a>
<ul class="ggvis-dropdown">
<li>
Renderer: 
<a id="plot_id335221466_renderer_svg" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id335221466" data-renderer="svg">SVG</a>
 | 
<a id="plot_id335221466_renderer_canvas" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id335221466" data-renderer="canvas">Canvas</a>
</li>
<li>
<a id="plot_id335221466_download" class="ggvis-download" data-plot-id="plot_id335221466">Download</a>
</li>
</ul>
</nav>
</div>
...
ggvis.getPlot("plot_id335221466").parseSpec(plot_id335221466_spec);
</script><!--/html_preserve-->
